...
const navigationItems = [
  ...
  { name: 'Voice & Telephony', href: '/telephony', icon: PhoneCall, category: 'Communication' },
  { name: 'Contacts', href: '/contacts', icon: Users, category: 'CRM Suite' },
  { name: 'Customer 360 CDP', href: '/cdp', icon: UserCheck, category: 'CRM Suite' },
  ...
  { name: 'Email Marketing', href: '/marketing', icon: Send, category: 'Platform' },
